...
class riders extends eidsr_base {
  function __construct($rapidpro_token,$rapidpro_ur,$csd_host,$csd_user,$csd_passwd,$csd_doc,$rp_csd_doc,$eidsr_host,$eidsr_user,$eidsr_passwd,$samples) {
    parent::__construct($rapidpro_token,$rapidpro_ur,$csd_host,$csd_user,$csd_passwd,$csd_doc,$rp_csd_doc,$eidsr_host,$eidsr_user,$eidsr_passwd);
